---
title: "esm204ass4"
author: "Katherine Orellana, Cristina Mancilla, Ridhima Chaudhuri"
date: "5/23/2022"
...
ggplot(damages,aes(x=warming_2, y=damages)) + 
  ...
  theme(strip.background = element_rect(color= "white", fill = "grey"))
...
warming<-warming %>%
  ...
  mutate(damages_differnce_ton = (damages_function(warming_pulse) - damages_function(warming_baseline)) / 3500000000)
...
ggplot(warming, aes(x = year, y = damages_baseline)) +
  ...
  labs(x = "Year", y = "Damages ($)", title = "Damages (w/o pulse) ($)") +
  theme_grey(14) +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
  theme(axis.title = element_text(face = "bold")) +
...
ggplot(warming, aes(x = year, y = damages_pulse)) +
  geom_point(size = 1, color= "blue") +
  labs(x = "Year", y = "Damages (with pulse)($)", title = "Damage with Pulse") +
  theme_grey(14) +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
  theme(axis.title = element_text(face = "bold")) +
  theme(strip.background = element_rect(color= "white", fill = "gray"))
...
ggplot(warming, aes(x = year, y = damages_difference)) +
  geom_point(size = 1,color= "blue") +
  labs(x = "Year", y = "Damages ($)", title = "Difference in Damages (with and w/o pulse)") +
  theme_grey(14) +
  theme(plot.title = element_text(hjust = 0.5, face = "bold")) +
  theme(axis.title = element_text(face = "bold")) +
  theme(strip.background = element_rect(color= "white", fill = "gray"))

ggplot(warming, aes(x = year, y = damages_differnce_ton )) +
  geom_point(size = 1, color= "blue") +
